...
app.post('/incompleteUpload',function(req,res){
    ...
    let fileObj = req.files.fileobj;
    var fileName = req.body.filename; //including file extension
    var study = !(req.body.study).trim() ? "N/A" : req.body.study;
    var subject = !(req.body.subject).trim() ? "N/A" : req.body.subject;
    var visit = !(req.body.visit).trim() ? "N/A" : req.body.visit;
    var session = !(req.body.session).trim() ? "N/A" : req.body.session;
    var docType = !(req.body.doctype).trim() ? "N/A" : req.body.doctype;
    ...
    var collecton = db.get('fileuploads');
    collection.insert({
        "filename":fileName,
        "study":study,
        "subject":subject,
